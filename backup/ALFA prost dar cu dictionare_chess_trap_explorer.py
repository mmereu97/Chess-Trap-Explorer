...
class TrapRepository:
    ...
    def import_traps(self, traps: List[ChessTrap]) -> int:
        ...
        # Retry logic pentru database locks
        max_retries = 3
        retry_delay = 1.0
        
        for attempt in range(max_retries):
            try:
                with sqlite3.connect(self.db_path, timeout=30.0) as conn:  # 30 secunde timeout
                    # Optimizări critice pentru viteză
                    conn.execute("PRAGMA journal_mode = WAL")  # WAL e mai bun pentru concurență
                ...
                if "locked" in str(e) and attempt < max_retries - 1:
                    print(f"[DEBUG DB] Database locked, retrying in {retry_delay} seconds... (attempt {attempt + 1}/{max_retries})")
...
class PGNImportService:
    ...
    def import_from_file(self, file_path: str, max_moves: int = 25, checkmate_only: bool = False, progress_callback=None) -> Tuple[int, int]:
        ...
        try:
            ...
            # Combinăm toate trap-urile și facem un singur import
            ...
            if all_traps:
                ...
                # Calculăm câte au fost de fiecare culoare
                white_imported = len([t for t in white_traps if any(t.moves == trap.moves for trap in all_traps[:imported_total])])
                ...
                print(f"[DEBUG PGN] No traps found to import")
                return 0, 0
    ...
    def import_from_folder(self, folder_path: str, max_moves: int = 25, checkmate_only: bool = False) -> Tuple[int, int]:
        ...
        # Procesăm fișierele în paralel folosind TOATE core-urile
        max_concurrent_files = cpu_count()  # Folosim toate core-urile pentru procesare maximă
    ...
    def _parse_pgn_file(self, file_path: str, max_moves: int, checkmate_only: bool) -> Tuple[List[ChessTrap], List[ChessTrap]]:
        ...
        # Determinăm numărul optim de worker-i - FOLOSIM TOATE CORE-URILE!
        num_workers = cpu_count()  # Folosim TOATE core-urile disponibile
...
class OpeningDatabase:
    """Bază de date eficientă pentru deschideri."""
    ...
    def _load_openings(self):
        ...
        self.openings[("e4", "e5", "Nf3", "Nc6")] = OpeningInfo("Italian/Spanish Position", "C44", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bb5")] = OpeningInfo("Spanish Opening (Ruy Lopez)", "C60", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bb5", "a6")] = OpeningInfo("Spanish: Morphy Defense", "C70", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4")] = OpeningInfo("Spanish: Morphy, Modern", "C78", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bb5", "a6", "Ba4", "Nf6")] = OpeningInfo("Spanish: Morphy, Closed", "C78", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bc4")] = OpeningInfo("Italian Game", "C50", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5")] = OpeningInfo("Italian: Classical", "C53", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bc4", "Nf6")] = OpeningInfo("Italian: Two Knights Defense", "C55", "Open")

        self.openings[("e4", "e5", "Nf3", "Nc6", "Bc4", "Nf6", "Ng5")] = OpeningInfo("Two Knights: Modern Attack", "C57", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bc4", "Nf6", "Ng5", "d5")] = OpeningInfo("Two Knights: Modern Attack", "C57", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bc4", "Nf6", "Ng5", "d5", "exd5")] = OpeningInfo("Two Knights: Fried Liver Attack", "C57", "Open")
        self.openings[("e4", "e5", "Nf3", "Nc6", "Bc4", "Nf6", "Ng5", "d5", "exd5", "Nxd5")] = OpeningInfo("Two Knights: Fried Liver Attack", "C57", "Open")
        ...
        self.openings[("e4", "e5", "Nf3", "Nc6", "d4", "exd4")] = OpeningInfo("Scotch Game", "C44", "Open")
        ...
        self.openings[("e4", "e5", "Bc4")] = OpeningInfo("Bishop's Opening", "C23", "Open")
        
        # DESCHIDERI SEMI-DESCHISE (1.e4 altceva)
        self.openings[("e4", "c5")] = OpeningInfo("Sicilian Defense", "B20", "Semi-Open")
        self.openings[("e4", "c5", "Nf3")] = OpeningInfo("Sicilian Defense", "B27", "Semi-Open")
        self.openings[("e4", "c5", "Nf3", "d6")] = OpeningInfo("Sicilian Defense", "B50", "Semi-Open")
        self.openings[("e4", "c5", "Nf3", "d6", "d4")] = OpeningInfo("Sicilian: Open", "B50", "Semi-Open")
        self.openings[("e4", "c5", "Nf3", "d6", "d4", "cxd4", "Nxd4")] = OpeningInfo("Sicilian: Open", "B50", "Semi-Open")
        self.openings[("e4", "c5", "Nf3", "d6", "d4", "cxd4", "Nxd4", "Nf6")] = OpeningInfo("Sicilian: Classical", "B56", "Semi-Open")
        ...
        self.openings[("e4", "c5", "Nf3", "Nc6")] = OpeningInfo("Sicilian: Nc6 Variation", "B30", "Semi-Open")
        self.openings[("e4", "c5", "Nf3", "Nc6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "e5")] = OpeningInfo("Sicilian: Sveshnikov", "B33", "Semi-Open")
        self.openings[("e4", "c5", "Nf3", "e6")] = OpeningInfo("Sicilian: French Variation", "B40", "Semi-Open")
        self.openings[("e4", "c5", "Nf3", "e6", "d4", "cxd4", "Nxd4", "a6")] = OpeningInfo("Sicilian: Paulsen", "B41", "Semi-Open")
        ...
        self.openings[("e4", "e6", "d4")] = OpeningInfo("French Defense", "C00", "Semi-Open")
        ...
        self.openings[("e4", "e6", "d4", "d5", "Nc3")] = OpeningInfo("French: Paulsen", "C10", "Semi-Open")
        ...
        self.openings[("e4", "c6", "d4")] = OpeningInfo("Caro-Kann Defense", "B10", "Semi-Open")
        self.openings[("e4", "c6", "d4", "d5")] = OpeningInfo("Caro-Kann Defense", "B10", "Semi-Open")
        self.openings[("e4", "c6", "d4", "d5", "Nc3")] = OpeningInfo("Caro-Kann: Main Line", "B15", "Semi-Open")
        self.openings[("e4", "c6", "d4", "d5", "e5")] = OpeningInfo("Caro-Kann: Advance", "B12", "Semi-Open")
        self.openings[("e4", "c6", "d4", "d5", "exd5", "cxd5")] = OpeningInfo("Caro-Kann: Exchange", "B13", "Semi-Open")
        self.openings[("e4", "d5")] = OpeningInfo("Scandinavian Defense", "B01", "Semi-Open")
        self.openings[("e4", "d5", "exd5")] = OpeningInfo("Scandinavian Defense", "B01", "Semi-Open")
        self.openings[("e4", "d5", "exd5", "Qxd5")] = OpeningInfo("Scandinavian: Main Line", "B01", "Semi-Open")
        self.openings[("e4", "d5", "exd5", "Nf6")] = OpeningInfo("Scandinavian: Modern", "B01", "Semi-Open")
        self.openings[("e4", "Nf6")] = OpeningInfo("Alekhine's Defense", "B02", "Semi-Open")
        self.openings[("e4", "Nf6", "e5")] = OpeningInfo("Alekhine's Defense", "B02", "Semi-Open")
        self.openings[("e4", "Nf6", "e5", "Nd5")] = OpeningInfo("Alekhine's Defense", "B02", "Semi-Open")
        self.openings[("e4", "d6")] = OpeningInfo("Pirc Defense", "B00", "Semi-Open")
        self.openings[("e4", "d6", "d4")] = OpeningInfo("Pirc Defense", "B07", "Semi-Open")
        self.openings[("e4", "d6", "d4", "Nf6")] = OpeningInfo("Pirc Defense", "B07", "Semi-Open")
        self.openings[("e4", "g6")] = OpeningInfo("Modern Defense", "B00", "Semi-Open")
        
        # DESCHIDERI ÎNCHISE (1.d4)
        self.openings[("d4",)] = OpeningInfo("Queen's Pawn Game", "A40", "Closed")
        ...
        self.openings[("d4", "d5", "c4", "e6", "Nc3")] = OpeningInfo("QGD: Classical", "D30", "Closed")
        self.openings[("d4", "d5", "c4", "e6", "Nc3", "Nf6")] = OpeningInfo("QGD: Classical", "D35", "Closed")
        ...
        self.openings[("d4", "d5", "c4", "c6", "Nf3")] = OpeningInfo("Slav Defense", "D11", "Closed")
        self.openings[("d4", "d5", "c4", "c6", "Nf3", "Nf6")] = OpeningInfo("Slav Defense", "D15", "Closed")
        self.openings[("d4", "d5", "c4", "c6", "Nf3", "Nf6", "Nc3", "dxc4")] = OpeningInfo("Slav: Czech Defense", "D17", "Closed")
        self.openings[("d4", "d5", "c4", "e6", "Nc3", "Nf6", "Nf3", "dxc4")] = OpeningInfo("QGD: Vienna", "D39", "Closed")
        self.openings[("d4", "d5", "Nf3")] = OpeningInfo("Queen's Pawn: Mason", "D00", "Closed")
        self.openings[("d4", "d5", "Nf3", "Nf6")] = OpeningInfo("Queen's Pawn Game", "D02", "Closed")
        self.openings[("d4", "d5", "Nf3", "Nf6", "c4")] = OpeningInfo("Queen's Gambit", "D06", "Closed")
        self.openings[("d4", "d5", "Bf4")] = OpeningInfo("London System", "D02", "Closed")
        self.openings[("d4", "d5", "Nf3", "Nf6", "Bf4")] = OpeningInfo("London System", "D02", "Closed")
        self.openings[("d4", "Nf6", "Bf4")] = OpeningInfo("London System", "A45", "Closed")
        self.openings[("d4", "Nf6", "Nf3", "e6", "Bf4")] = OpeningInfo("London System", "A46", "Closed")
        
        # DESCHIDERI INDIENE (1.d4 Nf6)
        self.openings[("d4", "Nf6")] = OpeningInfo("Indian Defense", "A45", "Indian")
        self.openings[("d4", "Nf6", "c4")] = OpeningInfo("Indian Defense", "A50", "Indian")
        self.openings[("d4", "Nf6", "c4", "e6")] = OpeningInfo("Indian: E6 System", "E00", "Indian")
        self.openings[("d4", "Nf6", "c4", "e6", "Nc3")] = OpeningInfo("Nimzo/Queen's Indian", "E00", "Indian")
        self.openings[("d4", "Nf6", "c4", "e6", "Nc3", "Bb4")] = OpeningInfo("Nimzo-Indian Defense", "E20", "Indian")
        self.openings[("d4", "Nf6", "c4", "e6", "Nf3")] = OpeningInfo("Indian Game", "E00", "Indian")
        self.openings[("d4", "Nf6", "c4", "e6", "Nf3", "b6")] = OpeningInfo("Queen's Indian Defense", "E12", "Indian")
        self.openings[("d4", "Nf6", "c4", "e6", "Nf3", "Bb4+")] = OpeningInfo("Bogo-Indian Defense", "E11", "Indian")
        self.openings[("d4", "Nf6", "c4", "e6", "g3")] = OpeningInfo("Catalan Opening", "E00", "Indian")
        self.openings[("d4", "Nf6", "c4", "g6")] = OpeningInfo("King's Indian Defense", "E60", "Indian")
        self.openings[("d4", "Nf6", "c4", "g6", "Nc3")] = OpeningInfo("King's Indian Defense", "E60", "Indian")
        self.openings[("d4", "Nf6", "c4", "g6", "Nc3", "Bg7")] = OpeningInfo("King's Indian Defense", "E61", "Indian")
        self.openings[("d4", "Nf6", "c4", "g6", "Nc3", "Bg7", "e4")] = OpeningInfo("King's Indian: Classical", "E90", "Indian")
        self.openings[("d4", "Nf6", "c4", "g6", "Nc3", "Bg7", "e4", "d6")] = OpeningInfo("King's Indian: Classical", "E92", "Indian")
        self.openings[("d4", "Nf6", "c4", "g6", "Nf3")] = OpeningInfo("King's Indian Defense", "E60", "Indian")
        self.openings[("d4", "Nf6", "c4", "g6", "g3")] = OpeningInfo("King's Indian: Fianchetto", "E62", "Indian")
        self.openings[("d4", "Nf6", "c4", "c5")] = OpeningInfo("Benoni Defense", "A56", "Indian")
        self.openings[("d4", "Nf6", "c4", "c5", "d5")] = OpeningInfo("Benoni Defense", "A56", "Indian")
        self.openings[("d4", "Nf6", "c4", "c5", "d5", "e6")] = OpeningInfo("Modern Benoni", "A60", "Indian")
        self.openings[("d4", "Nf6", "c4", "d6")] = OpeningInfo("Old Indian Defense", "A53", "Indian")
        self.openings[("d4", "Nf6", "Nf3")] = OpeningInfo("Indian Game", "A46", "Indian")
        self.openings[("d4", "Nf6", "Nf3", "g6")] = OpeningInfo("King's Indian Setup", "A48", "Indian")
        self.openings[("d4", "Nf6", "Nf3", "e6")] = OpeningInfo("Indian Game", "A46", "Indian")
        self.openings[("d4", "Nf6", "Nf3", "d5")] = OpeningInfo("Queen's Pawn Game", "D02", "Indian")
        
        # DESCHIDERI FLANK (1.Nf3, 1.c4, 1.g3, etc.)
        self.openings[("Nf3",)] = OpeningInfo("Réti Opening", "A04", "Flank")
        self.openings[("Nf3", "d5")] = OpeningInfo("Réti Opening", "A06", "Flank")
        self.openings[("Nf3", "d5", "g3")] = OpeningInfo("Réti: King's Indian Attack", "A07", "Flank")
        self.openings[("Nf3", "Nf6")] = OpeningInfo("Réti Opening", "A04", "Flank")
        self.openings[("Nf3", "Nf6", "g3")] = OpeningInfo("Réti: King's Indian Attack", "A05", "Flank")
        self.openings[("c4",)] = OpeningInfo("English Opening", "A10", "Flank")
        self.openings[("c4", "e5")] = OpeningInfo("English Opening", "A20", "Flank")
        self.openings[("c4", "e5", "Nc3")] = OpeningInfo("English: Sicilian Reversed", "A22", "Flank")
        self.openings[("c4", "c5")] = OpeningInfo("English: Symmetrical", "A30", "Flank")
        self.openings[("c4", "Nf6")] = OpeningInfo("English Opening", "A15", "Flank")
        self.openings[("c4", "Nf6", "Nc3")] = OpeningInfo("English Opening", "A16", "Flank")
        self.openings[("c4", "e6")] = OpeningInfo("English Opening", "A13", "Flank")
        self.openings[("c4", "c6")] = OpeningInfo("English: Caro-Kann System", "A11", "Flank")
        self.openings[("c4", "g6")] = OpeningInfo("English: Modern Defense", "A10", "Flank")
        self.openings[("g3",)] = OpeningInfo("Hungarian Opening", "A00", "Flank")
        self.openings[("g3", "d5")] = OpeningInfo("Hungarian Opening", "A00", "Flank")
        self.openings[("g3", "e5")] = OpeningInfo("Hungarian Opening", "A00", "Flank")
        self.openings[("b3",)] = OpeningInfo("Larsen's Opening", "A01", "Flank")
        self.openings[("f4",)] = OpeningInfo("Bird's Opening", "A02", "Flank")
        self.openings[("f4", "e5")] = OpeningInfo("Bird: From Gambit", "A02", "Flank")
        self.openings[("f4", "d5")] = OpeningInfo("Bird's Opening", "A03", "Flank")
        
        # DESCHIDERI NEREGULATE
        self.openings[("e3",)] = OpeningInfo("Van't Kruijs Opening", "A00", "Irregular")
        self.openings[("d3",)] = OpeningInfo("Mieses Opening", "A00", "Irregular")
        self.openings[("Nc3",)] = OpeningInfo("Dunst Opening", "A00", "Irregular")
        self.openings[("a3",)] = OpeningInfo("Anderssen's Opening", "A00", "Irregular")
        self.openings[("h3",)] = OpeningInfo("Clemenz Opening", "A00", "Irregular")
        self.openings[("a4",)] = OpeningInfo("Ware Opening", "A00", "Irregular")
        self.openings[("h4",)] = OpeningInfo("Kadas Opening", "A00", "Irregular")
    ...
    def get_opening_name(self, moves: List[str]) -> Optional[OpeningInfo]:
        ...
        # Căutăm cea mai lungă potrivire
    ...
    def get_opening_at_position(self, moves: List[str]) -> str:
        """Returnează numele deschiderii la poziția curentă."""
        opening_info = self.get_opening_name(moves)
        if opening_info:
            result = f"{opening_info.name} ({opening_info.eco_code})"
            return result
        elif not moves:
    ...
    def get_opening_phase_info(self, moves: List[str]) -> Tuple[str, str]:
        ...
        # Analiza specifică pentru anumite deschideri
        if "Fried Liver" in opening_info.name:
            return f"{base_text} - Attacking!", f"{base_text} - Under pressure!"
        elif "Gambit" in opening_info.name:
            if "Accepted" in opening_info.name:
                return f"{base_text} - Material up", f"{base_text} - Sacrificed pawn"
            else:
                return f"{base_text} - Offering gambit", f"{base_text} - Can accept gambit"
        elif "Defense" in opening_info.name:
            return f"{base_text} - Challenging", f"{base_text} - Defending"
        elif "Italian" in opening_info.name:
            return f"{base_text} - Classical play", f"{base_text} - Solid setup"
        elif "Spanish" in opening_info.name or "Ruy Lopez" in opening_info.name:
            return f"{base_text} - Strategic pressure", f"{base_text} - Flexible defense"
        elif "Sicilian" in opening_info.name:
            return f"{base_text} - Sharp counterplay", f"{base_text} - Fighting for initiative"
        elif "French" in opening_info.name:
            return f"{base_text} - Space advantage", f"{base_text} - Solid structure"
        elif "Caro-Kann" in opening_info.name:
            return f"{base_text} - Central control", f"{base_text} - Rock solid"
        elif "Queen's Gambit" in opening_info.name:
            return f"{base_text} - Central pressure", f"{base_text} - Fighting for center"
        else:
...
class Renderer:
    ...
    def render_status(self, surface: pygame.Surface, state: GameState, white_info: str, black_info: str) -> None:
        ...
        # DESCHIDEREA SUS (perspectiva negrului)
        opening_top_y = self.config.TOP_MARGIN - 30
        
        # Text pentru negru
        black_perspective_text = f"♛ {black_info}"
        opening_surface_top = self.font.render(black_perspective_text, True, (200, 200, 200))
        opening_rect_top = opening_surface_top.get_rect(center=(self.config.LEFT_MARGIN + self.config.BOARD_SIZE // 2, opening_top_y))
        
        # Fundal pentru contrast sus
        bg_rect_top = opening_rect_top.inflate(20, 10)
        pygame.draw.rect(surface, (40, 40, 40), bg_rect_top)
        pygame.draw.rect(surface, (80, 80, 80), bg_rect_top, 2)
        
        surface.blit(opening_surface_top, opening_rect_top)
        
        # DESCHIDEREA JOS (perspectiva albului)
        opening_bottom_y = self.config.TOP_MARGIN + self.config.BOARD_SIZE + 45
        
        # Text pentru alb
        white_perspective_text = f"♔ {white_info}"
        opening_surface_bottom = self.font.render(white_perspective_text, True, (200, 200, 200))
        opening_rect_bottom = opening_surface_bottom.get_rect(center=(self.config.LEFT_MARGIN + self.config.BOARD_SIZE // 2, opening_bottom_y))
        
        # Fundal pentru contrast jos
        bg_rect_bottom = opening_rect_bottom.inflate(20, 10)
        pygame.draw.rect(surface, (40, 40, 40), bg_rect_bottom)
        pygame.draw.rect(surface, (80, 80, 80), bg_rect_bottom, 2)
        
        surface.blit(opening_surface_bottom, opening_rect_bottom)
        
        # TURN INDICATOR - colorează chenarul corespunzător
        if state.board.turn == state.current_player:
            if state.current_player == chess.WHITE:
                pygame.draw.rect(surface, (255, 255, 100), bg_rect_bottom, 3)
            else:
                pygame.draw.rect(surface, (255, 255, 100), bg_rect_top, 3)
            turn_text = "Your turn to move"
        else:
            turn_text = "Opponent's turn"
        
        # Afișează textul pentru turn
        turn_surface = self.small_font.render(turn_text, True, (255, 255, 100))
        turn_rect = turn_surface.get_rect(center=(self.config.LEFT_MARGIN + self.config.BOARD_SIZE // 2, self.config.TOP_MARGIN - 5))
        ...
        if state.is_recording:
            ...
            surface.blit(record_surface, (self.config.LEFT_MARGIN, opening_top_y - 25))
    ...
    def render_history_panel(self, surface: pygame.Surface, move_history: List[str]) -> pygame.Rect:
        ...
        # Calculează poziția panoului sub tablă, dar mai jos ca să nu acopere textul
        panel_y = self.config.TOP_MARGIN + self.config.BOARD_SIZE + 80  # Era +15, acum e +80
        panel_height = 100  # Înălțime fixă mai mică în loc de HEIGHT - panel_y - 20
        
        # Verifică să nu depășească partea de jos a ecranului
        if panel_y + panel_height > self.config.HEIGHT - 20:
